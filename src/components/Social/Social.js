    ...
    if (mobile) {
        return (
            <div className={classes.mobileWrapper}>
                <IconBtn icon={GitHub} m={1} href="https://github.com/jadesolaadeagbo" />
                <IconBtn icon={Instagram} m={1} href="https://www.instagram.com/jadesolaadeagbo/" />
                <IconBtn icon={LinkedIn} m={1} href="https://www.linkedin.com/in/jadesolaadeagbo" />
                <IconBtn icon={Email} m={1} href="mailto:jadesolaadeagbo@gmail.com" />
            </div>
        );
    } else {
        return (
